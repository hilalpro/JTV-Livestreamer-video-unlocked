...
class JustinTV(Plugin):
    ...
    APIBaseURL = "http://anzas21.sakura.ne.jp/proxy/browse.php?u=http://usher.justin.tv"
    StreamInfoURL = APIBaseURL + "%2Ffind%2F{0}.json%3Ftype%3Dany%26p%3D629714%26group%3D%26channel_subscription%3D6C0E2f81b2F8a2f70AC0808c4B3B5D2D%26b_id%3Dtrue%26chansub_guid%3D6C0E2f81b2F8a2f70AC0808c4B3B5D2D%26private_code%3Dnull"
    ...
    HLSStreamTokenURL = "http://usher.justin.tv/stream/iphone_token/{0}.json"
    HLSPlaylistURL = "http://usher.justin.tv/stream/multi_playlist/{0}.m3u8"
    HLSTranscodeRequest = "http://usher.justin.tv/stream/transcode_iphone.json"
